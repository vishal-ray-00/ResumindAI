    ...
    return (
        <header className="fixed inset-x-0 top-4 z-50 px-4 sm:px-6">
            <div className="mx-auto w-full max-w-6xl">
                <nav className="relative overflow-hidden rounded-[28px] border border-[#A3FF12]/10 bg-black/70 shadow-[0_20px_70px_rgba(0,0,0,0.55)] backdrop-blur-2xl">
                    {/* Subtle Inner Border */}
                    ...
                    <div className="relative flex items-center justify-between gap-4 px-4 py-2.5 sm:px-6">
                        ...
                        <Link to="/" className="flex items-center gap-3">
                            <img className="h-10 w-10 object-contain" src={ResumindLogo} alt="Resumind Logo" />
                    ...
                    {/* Mobile Menu */}
                    {isOpen && (
                        <div className="relative border-t border-white/10 px-4 pt-3 pb-4 md:hidden">
